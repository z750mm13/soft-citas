...
<div class="container">
    ...
    <div class="card mb-5 shadow">
        ...
        <div class="card-body mx-4 pb-5">
            ...
            <p class="card-text text-justify"><b>{{$prescription->medicine->name}}:</b> {{$prescription->dose}}{{$prescription->description?', '.$prescription->description:''}}{{$prescription->medicine->details?', '.$prescription->medicine->details:''}}.</p>
            @endforeach
            @endif
        </div>
